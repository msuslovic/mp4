...
d <- d_timeline %>%
  ...
  geom_line()+
  labs(title= "Percent of Female Directors From (1911-2017) ", x = "Year of Production",  y = "Percent of Female Directors", caption = "Source: IMDB")
  
t_total <- d_timeline %>%
  ggplot(aes( x = Production_year, y = sum_n))+
  geom_line()+
  labs(title= "Total Number of Directors From (1911-2017) ", x = "Year of Production",  y = "Number of Directors", caption = "Source: IMDB")
...
w <- w_timeline %>%
  ggplot(aes( x = Production_year, y = p))+
  geom_line()+
  labs(title= "Percent of Female Writers From (1912-2017) ", x = "Year of Production",  y = "Percent of Female Writers", caption = "Source: IMDB")
  
w_total <- w_timeline %>%
  ggplot(aes( x = Production_year, y = sum_n))+
  geom_line()+
  labs(title= "Number of All Writers From (1912-2017) ", x = "Year of Production",  y = "Number of Writers", caption = "Source: IMDB")
...
p <- p_timeline %>%
  ggplot(aes(x = Production_year, y = p))+
  geom_line()+
  labs(title= "Percent of Female Producers From (1911-2017) ", x = "Year of Production",  y = "Percent of Female Producers", caption = "Source: IMDB")
